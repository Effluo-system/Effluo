...
resource "aws_security_group" "rds_sg" {
  ...
  ingress {
    ...
    to_port     = var.db_port
    protocol    = "tcp"
    cidr_blocks = ["0.0.0.0/0"] # open to the world for now
  }
...
resource "aws_db_instance" "postgres" {
  ...
  tags = {
    Name = "Effluo PostgreSQL Database"
  }
}
